...
class DriverTransports : Fragment() {
    ...
    private fun loadDemands() {
        ...
        val request = Request.Builder()
            .url("${Constants.BASE_URL}/transporters/demands/getDemandsbyDriverID.php")
            .post(formBody)
            .build()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_driver_transports, container, false)
        recyclerView = view.findViewById(R.id.driverTransportsrecyclerView)
